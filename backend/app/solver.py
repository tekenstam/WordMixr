...
def load_dictionary() -> tuple[set, dict]:
            ...
            try:
                with open(filepath, "r", encoding="utf-8") as f:
                    ...
                    for word in f:
                        ...
                        if word and len(word) >= 2:  # Only include words with 2+ characters
                            words.add(word)
    ...
    fallback_words = {
        'the', 'be', 'to', 'of', 'and', 'in', 'have', 'it', 'for', 'not',
        ...
        'because', 'any', 'these', 'give', 'day', 'most', 'us', 'cat', 'dog',
        'run', 'sun', 'fun', 'gun', 'cut', 'put', 'but', 'get', 'set', 'let',
        'net', 'pet', 'wet', 'yet', 'met', 'bet', 'eat', 'hat', 'bat', 'rat',
        'cat', 'fat', 'sat', 'mat', 'pat', 'bad', 'sad', 'mad', 'had', 'bag',
        'tag', 'lag', 'rag', 'big', 'dig', 'fig', 'pig', 'wig', 'hot', 'pot',
        'lot', 'not', 'got', 'top', 'pop', 'hop', 'cop', 'red', 'bed', 'led',
        'fed', 'ten', 'pen', 'hen', 'men', 'den', 'yes', 'bus', 'box', 'fox',
        'six', 'mix', 'fix', 'zip', 'tip', 'lip', 'hip', 'dip', 'cup', 'pup'
    }
...
def is_valid_word(word, min_length=3, dictionary_type="scowl_large"):
    ...
    if dictionary_type == "comprehensive":
        ...
        problematic_words = {
            'haec', 'hic', 'hoc', 'chab', 'bache', 'habe', 'bch', 'ech', 'hae',
            'ecb', 'hcb', 'ceh', 'beh', 'heb', 'chb', 'bhc'
        }
