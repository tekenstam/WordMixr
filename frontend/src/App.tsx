          ...
          {themeName === 'original' ? (
            ...
            <>
                ...
                {['W', 'O', 'R', 'D'].map((letter, index) => (
                  <div
                    ...
                    style={{
                      width: '40px',
                      height: '40px',
                      background: index === 1 || index === 2 ? theme.colors.primary : theme.colors.secondary,
                      color: index === 1 || index === 2 ? '#fff' : theme.colors.text.primary,
              ...
              <p style={{
                ...
                🔥 Cook up words from scrambled letters! Perfect for Word Cookies and word puzzles.
              </p>
            </>
          )}
        </header>
